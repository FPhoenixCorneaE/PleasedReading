...
public class ParallaxRecyclerViewDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parallax_activity_demo);
        initView();
    }
        ...
        mRvParallax.setAdapter(
                new ParallaxRecyclerAdapter(
                        ...
                        .setOnItemClickListener((holder, position) -> {
                            Toast.makeText(ParallaxRecyclerViewDemoActivity.this, "Clicked " + position, Toast.LENGTH_SHORT).show();
                        }));
    }
}
