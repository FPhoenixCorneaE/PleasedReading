...
import com.wkz.okgo.model.OkPriority;
 ...
 * 带有优先级的阻塞队列
 */
public class OkPriorityBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
    ...
    public OkPriorityBlockingQueue() {
        this(Integer.MAX_VALUE);
    }

    public OkPriorityBlockingQueue(int capacity) {
        if (capacity <= 0) throw new IllegalArgumentException();
        this.capacity = capacity;
        last = head = new Node<E>(null);
    }

    public OkPriorityBlockingQueue(Collection<? extends E> c) {
        this(Integer.MAX_VALUE);
        final ReentrantLock putLock = this.putLock;
    ...
    class Node<T> {
        ...
        private OkPriorityObject<?> value;
        Node<T> next;
        ...
        public void setValue(T value) {
            if (value == null) {
                this.value = null;
            } else if (value instanceof OkPriorityObject) {
                this.value = (OkPriorityObject<?>) value;
                this.valueAsT = true;
            } else {
                this.value = new OkPriorityObject<T>(OkPriority.DEFAULT, value);
            }
        }
    }
