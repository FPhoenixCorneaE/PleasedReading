 ...
 */
public class OkSharedPreferencesCookieStore implements IOkCookieStore {
    ...
    public OkSharedPreferencesCookieStore(Context context) {
            ...
            if ((entry.getValue()) != null && !entry.getKey().startsWith(COOKIE_NAME_PREFIX)) {
                ...
                for (String name : cookieNames) {
                    ...
                    if (encodedCookie != null) {
                        Cookie decodedCookie = OkSerializableCookie.decodeCookie(encodedCookie);
    ...
    private void saveCookie(HttpUrl url, Cookie cookie, String cookieToken) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + cookieToken, OkSerializableCookie.encodeCookie(url.host(), cookie));
        prefsWriter.apply();
    }
