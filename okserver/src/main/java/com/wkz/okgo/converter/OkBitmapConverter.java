 ...
 * 图片转换器
 */
public class OkBitmapConverter implements IOkConverter<Bitmap> {
    ...
    public OkBitmapConverter() {
        this(1000, 1000, Bitmap.Config.ARGB_8888, ImageView.ScaleType.CENTER_INSIDE);
    }

    public OkBitmapConverter(int maxWidth, int maxHeight) {
        this(maxWidth, maxHeight, Bitmap.Config.ARGB_8888, ImageView.ScaleType.CENTER_INSIDE);
    }

    public OkBitmapConverter(int maxWidth, int maxHeight, Bitmap.Config decodeConfig, ImageView.ScaleType scaleType) {
