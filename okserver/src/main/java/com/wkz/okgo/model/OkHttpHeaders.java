 ...
 * 请求头的包装类
 */
public class OkHttpHeaders implements Serializable {
    ...
    public OkHttpHeaders() {
        init();
    }

    public OkHttpHeaders(String key, String value) {
        init();
        put(key, value);
    }
    ...
    public void put(OkHttpHeaders headers) {
        if (headers != null) {
    ...
    public String toString() {
        return "OkHttpHeaders{" + "headersMap=" + headersMap + '}';
    }
}
