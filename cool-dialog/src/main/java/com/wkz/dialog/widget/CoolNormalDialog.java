...
public class CoolNormalDialog extends CoolBaseAlertDialog<CoolNormalDialog> {
    /**
     * title underline
     */
    ...
    public CoolNormalDialog(Context context) {
        super(context);
    ...
    public void setUiBeforeShow() {
        ...
        mTvBtnLeft.setBackgroundDrawable(CoolCornerUtils.btnSelector(radius, mBgColor, mBtnPressColor, 0));
        mTvBtnRight.setBackgroundDrawable(CoolCornerUtils.btnSelector(radius, mBgColor, mBtnPressColor, 1));
        mTvBtnMiddle.setBackgroundDrawable(CoolCornerUtils.btnSelector(mBtnNum == 1 ? radius : 0, mBgColor, mBtnPressColor, -1));
    }
     ...
     * set style(设置style)
     */
    public CoolNormalDialog style(int style) {
        this.mStyle = style;
        return this;
    }
     ...
     */
    public CoolNormalDialog titleLineColor(int titleLineColor) {
     ...
     */
    public CoolNormalDialog titleLineHeight(float titleLineHeight_DP) {
     ...
     */
    public CoolNormalDialog dividerColor(int dividerColor) {
