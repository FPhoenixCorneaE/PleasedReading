...
import com.wkz.dialog.base.CoolBottomBaseDialog;
 ...
 */
public class CoolActionSheetDialog extends CoolBottomBaseDialog<CoolActionSheetDialog> {
    /**
     * ListView
     */
    ...
    public CoolActionSheetDialog(Context context, ArrayList<CoolDialogMenuItem> baseItems, View animateView) {
        super(context, animateView);
        mContents.addAll(baseItems);
        init();
    }

    public CoolActionSheetDialog(Context context, String[] items, View animateView) {
        super(context, animateView);
    ...
    public CoolActionSheetDialog(Context context, BaseAdapter adapter, View animateView) {
        super(context, animateView);
        mAdapter = adapter;
        init();
    }
    ...
    public void setUiBeforeShow() {
        ...
        mTvCancel.setBackgroundDrawable(CoolCornerUtils.listItemSelector(radius, mLvBgColor, mItemPressColor, 1, 0));
     ...
     */
    public CoolActionSheetDialog titleBgColor(int titleBgColor) {
     ...
     */
    public CoolActionSheetDialog title(String title) {
        mTitle = title;
        return this;
    }
     ...
     */
    public CoolActionSheetDialog titleHeight(float titleHeight) {
     ...
     */
    public CoolActionSheetDialog titleTextSize_SP(float titleTextSize_SP) {
     ...
     */
    public CoolActionSheetDialog titleTextColor(int titleTextColor) {
     ...
     */
    public CoolActionSheetDialog isTitleShow(boolean isTitleShow) {
     ...
     */
    public CoolActionSheetDialog lvBgColor(int lvBgColor) {
     ...
     */
    public CoolActionSheetDialog cornerRadius(float cornerRadius_DP) {
     ...
     */
    public CoolActionSheetDialog dividerColor(int dividerColor) {
     ...
     */
    public CoolActionSheetDialog dividerHeight(float dividerHeight_DP) {
     ...
     */
    public CoolActionSheetDialog itemPressColor(int itemPressColor) {
        mItemPressColor = itemPressColor;
        return this;
    }

    /**
     * set item textColor(item字体颜色)* @return CoolActionSheetDialog
     */
    public CoolActionSheetDialog itemTextColor(int itemTextColor) {
     ...
     */
    public CoolActionSheetDialog itemTextSize(float itemTextSize_SP) {
     ...
     */
    public CoolActionSheetDialog itemHeight(float itemHeight_DP) {
     ...
     */
    public CoolActionSheetDialog layoutAnimation(LayoutAnimationController lac) {
        mLac = lac;
        return this;
    }
     ...
     */
    public CoolActionSheetDialog cancelText(String cancelText) {
     ...
     * cancel btn text color(取消按钮文字颜色)
     */
    public CoolActionSheetDialog cancelText(int cancelTextColor) {
     ...
     * cancel btn text size(取消按钮文字大小)
     */
    public CoolActionSheetDialog cancelTextSize(float cancelTextSize) {
