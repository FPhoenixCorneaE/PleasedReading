...
public abstract class CoolBasePopup<T extends CoolBasePopup<T>> extends CoolInternalBasePopup<T> {
    protected View mWrappedView;
    protected LinearLayout mLlContent;
    protected boolean mAlignCenter;

    public CoolBasePopup(Context context) {
        super(context);
    ...
    public View onCreateView() {
        View inflate = View.inflate(mContext, R.layout.cool_popup_base, null);
