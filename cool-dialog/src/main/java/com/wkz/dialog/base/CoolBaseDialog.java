...
public abstract class CoolBaseDialog<T extends CoolBaseDialog<T>> extends Dialog {
    /**
     * mTag(日志)
     */
     ...
     * mShowAnim(对话框显示动画)
     */
    private CoolBaseAnimatorSet mShowAnim;
    /**
     * mDismissAnim(对话框消失动画)
     */
    private CoolBaseAnimatorSet mDismissAnim;
    /**
     * top container(最上层容器)
     */
     ...
     */
    public CoolBaseDialog(Context context) {
        super(context);
        setDialogTheme();
        mContext = context;
    ...
    public CoolBaseDialog(Context context, boolean isPopupStyle) {
        this(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxHeight = mDisplayMetrics.heightPixels - CoolStatusBarUtils.getHeight(mContext);
    ...
    public void onAttachedToWindow() {
        ...
        if (mShowAnim != null) {
            mShowAnim.listener(new CoolBaseAnimatorSet.AnimatorListener() {
                @Override
            ...
            CoolBaseAnimatorSet.reset(mLlControlHeight);
            delayDismiss();
        }
    }
    ...
    public void dismiss() {
        ...
        if (mDismissAnim != null) {
            mDismissAnim.listener(new CoolBaseAnimatorSet.AnimatorListener() {
                @Override
                public void onAnimationStart(Animator animator) {
                    mIsDismissAnim = true;
                }
    ...
    public void showAtLocation(int x, int y) {
        int gravity = Gravity.START | Gravity.TOP;//Left Top (坐标原点为右上角)
     ...
     */
    public T showAnim(CoolBaseAnimatorSet showAnim) {
        mShowAnim = showAnim;
        return (T) this;
    }
     ...
     */
    public T dismissAnim(CoolBaseAnimatorSet dismissAnim) {
