...
public class CoolCornerUtils {
     ...
     */
    public static StateListDrawable btnSelector(float radius, int normalColor, int pressedColor, int position) {
