...
package com.wkz.framework.widgets.itemdecoration;
...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mIncludeHeader) {
            if (parent.getAdapter() instanceof FRBaseRecyclerAdapter) {
                int headerCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getHeaderCount();
                int footerCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getFooterCount();
                int dataCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getDataCount();
