 ...
 */
public class FROverScrollFrameLayout extends FrameLayout implements OnTouchListener {
    ...
    public FROverScrollFrameLayout(Context context) {
        this(context, null);
    }

    public FROverScrollFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FROverScrollFrameLayout(Context context, AttributeSet attrs, int defStyle) {
