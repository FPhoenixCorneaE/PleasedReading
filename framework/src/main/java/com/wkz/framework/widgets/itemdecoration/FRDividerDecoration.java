...
public class FRDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof FRBaseRecyclerAdapter) {
            headerCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getFooterCount();
        }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof FRBaseRecyclerAdapter) {
            headerCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getFooterCount();
            dataCount = ((FRBaseRecyclerAdapter) parent.getAdapter()).getDataCount();
        } else {
