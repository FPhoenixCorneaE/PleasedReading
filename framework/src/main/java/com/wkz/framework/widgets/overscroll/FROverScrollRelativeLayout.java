 ...
 */
public class FROverScrollRelativeLayout extends RelativeLayout {
    ...
    private OnOverScrollCheckListener checkListener;
    ...
    public FROverScrollRelativeLayout(Context context) {
        super(context);
        init();
    }

    public FROverScrollRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FROverScrollRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @SuppressWarnings("NewApi")
    public FROverScrollRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public OnOverScrollCheckListener getOverScrollCheckListener() {
     ...
     */
    public void setOverScrollCheckListener(OnOverScrollCheckListener checkListener) {
