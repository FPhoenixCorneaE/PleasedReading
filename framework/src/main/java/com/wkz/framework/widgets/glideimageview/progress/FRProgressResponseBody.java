 ...
 */
public class FRProgressResponseBody extends ResponseBody {
    ...
    public FRProgressResponseBody(String url, ResponseBody responseBody, OnProgressListener progressListener) {
        this.imageUrl = url;
