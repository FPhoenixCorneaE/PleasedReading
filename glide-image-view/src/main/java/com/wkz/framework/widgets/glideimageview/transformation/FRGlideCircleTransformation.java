package com.wkz.framework.widgets.glideimageview.transformation;
 ...
 */
public class FRGlideCircleTransformation extends BitmapTransformation {

    public FRGlideCircleTransformation() {
    }
