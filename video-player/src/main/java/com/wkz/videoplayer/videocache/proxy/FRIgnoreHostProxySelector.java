 ...
 */
class FRIgnoreHostProxySelector extends ProxySelector {
    ...
    FRIgnoreHostProxySelector(ProxySelector defaultProxySelector, String hostToIgnore, int portToIgnore) {
        this.defaultProxySelector = FRPreconditions.checkNotNull(defaultProxySelector);
        this.hostToIgnore = FRPreconditions.checkNotNull(hostToIgnore);
        this.portToIgnore = portToIgnore;
    }

    static void install(String hostToIgnore, int portToIgnore) {
        ProxySelector defaultProxySelector = ProxySelector.getDefault();
        ProxySelector ignoreHostProxySelector = new FRIgnoreHostProxySelector(defaultProxySelector, hostToIgnore, portToIgnore);
