...
public class FRGetRequest {
    ...
    public FRGetRequest(String request) {
        FRPreconditions.checkNotNull(request);
    ...
    public static FRGetRequest read(InputStream inputStream) throws IOException {
        ...
        return new FRGetRequest(stringRequest.toString());
    }
