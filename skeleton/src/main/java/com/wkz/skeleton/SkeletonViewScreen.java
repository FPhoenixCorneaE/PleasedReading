...
public class SkeletonViewScreen implements ISkeletonScreen {
    private static final String TAG = SkeletonViewScreen.class.getName();
    ...
    private ShimmerLayout generateShimmerContainerLayout(ViewGroup parentView) {
        final ShimmerLayout shimmerLayout = (ShimmerLayout) LayoutInflater.from(mActualView.getContext()).inflate(R.layout.skeleton_layout_shimmer, parentView, false);
    ...
    public static class Builder {
         ...
         */
        public SkeletonViewScreen.Builder shimmer(boolean shimmer) {
         ...
         */
        public SkeletonViewScreen.Builder duration(int shimmerDuration) {
         ...
         */
        public SkeletonViewScreen.Builder angle(@IntRange(from = 0, to = 30) int shimmerAngle) {
            this.mShimmerAngle = shimmerAngle;
            return this;
        }

        public SkeletonViewScreen show() {
            SkeletonViewScreen skeletonScreen = new SkeletonViewScreen(this);
            skeletonScreen.show();
