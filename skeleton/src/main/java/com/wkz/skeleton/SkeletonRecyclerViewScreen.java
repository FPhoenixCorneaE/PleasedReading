...
public class SkeletonRecyclerViewScreen implements ISkeletonScreen {
    ...
    public static class Builder {
        ...
        private int mItemResID = R.layout.skeleton_item_recycler_default;
        ...
        public SkeletonRecyclerViewScreen show() {
            SkeletonRecyclerViewScreen recyclerViewSkeleton = new SkeletonRecyclerViewScreen(this);
